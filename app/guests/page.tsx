  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2">Guests</h1>
          <p className="text-sm sm:text-base text-gray-400">Manage guest information and check-ins</p>
        </div>
        <a
          href="/guests/new"
