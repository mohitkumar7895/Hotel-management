...
export default function NewGuestPage() {
  ...
  const onSubmit = async (data: GuestForm) => {
    ...
    try {
      ...
      // Get roomTypeId from state - use selectedRoomType directly
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] p-3 sm:p-4 md:p-6">
      ...
      <div className="bg-[#1e293b] rounded-lg border border-[#334155] p-4 sm:p-5 md:p-6">
        <h1 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2">Add Guest</h1>
        <p className="text-sm sm:text-base text-gray-400">Register a new guest</p>
      </div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (value !== 'custom') {
                  ...
                  setValue('roomTypeId', customRoomType || '', { shouldValidate: true });
                }
              }}
            ...
            {selectedRoomType === 'custom' && (
              <input
                ...
                onChange={(e) => {
                  ...
                  setValue('roomTypeId', e.target.value, { shouldValidate: true });
                }}
