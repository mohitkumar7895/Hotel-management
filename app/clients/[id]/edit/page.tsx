    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400">Update client information and logo</p>
        </div>
      </div>
              ...
              <div className="w-32 h-32 bg-[#0f172a] border border-[#334155] rounded-lg flex items-center justify-center overflow-hidden">
                {logoPreview ? (
                  <div className="relative w-full h-full">
                    <img
                      src={logoPreview.startsWith('data:') ? logoPreview : `${logoPreview}?t=${Date.now()}`}
                      alt="Logo preview"
