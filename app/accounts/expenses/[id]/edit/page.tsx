  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white mb-2">Edit Expense Entry</h1>
          <p className="text-gray-400">Update expense transaction details</p>
        </div>
      </div>
      ...
      <div className="bg-[#1e293b] rounded-lg border border-[#334155] p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-[#334155]">
            ...
            >
              {loading ? 'Updating...' : 'Update Expense Entry'}
            </button>
          </div>
        </form>
      </div>
