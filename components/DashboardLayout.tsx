...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    // Authentication removed - set default user
    setUser({ name: 'User', email: 'user@hotel.com' });
  }, []);

  const handleLogout = () => {
    // Authentication removed - logout disabled
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-[#1e293b] border-b border-[#334155] flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-semibold text-white">Hotel Name Placeholder</h2>
          </div>
